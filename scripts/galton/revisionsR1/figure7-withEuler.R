...
all.train.data$eulerAgeReg <- NA
ind <- which(!is.na(all.train.data$mean_euler))
all.train.data$eulerAgeReg[ind] <- lm(mean_euler ~ age + ageSq + sex, data=all.train.data)$residuals
...
meanValsAgeRegEuler <- cbind(cor(meanCTAgeReg, eulerAgeReg, method='spearman', use='complete'),
                                       cor(meanGMDAgeReg, eulerAgeReg, method='spearman', use='complete'),
                                       cor(meanVOLAgeReg, eulerAgeReg, method='spearman', use='complete'),
                                       cor(as.numeric(meanFSCtAgeReg), eulerAgeReg, method='spearman', use='complete'),
                                       cor(as.numeric(TotalGrayVolAgeReg), eulerAgeReg, method='spearman', use='complete'))
...
meanValsAgeRegEulerPVal <- cbind(cor.test(meanCTAgeReg, eulerAgeReg, use='complete',method='spearman')$p.value,
                                       cor.test(meanGMDAgeReg, eulerAgeReg, use='complete',method='spearman')$p.value,
                                       cor.test(meanVOLAgeReg, eulerAgeReg, use='complete',method='spearman')$p.value,
                                       cor.test(as.numeric(meanFSCtAgeReg), eulerAgeReg, use='complete',method='spearman')$p.value,
                                       cor.test(as.numeric(TotalGrayVolAgeReg), eulerAgeReg,use='complete', method='spearman')$p.value)
...
meanValsAgeRegEulerValid <- cbind(cor(meanCTAgeReg, eulerAgeReg, method='spearman', use='complete'),
                                       cor(meanGMDAgeReg, eulerAgeReg, method='spearman', use='complete'),
                                       cor(meanVOLAgeReg, eulerAgeReg, method='spearman', use='complete'),
                                       cor(as.numeric(meanFSCtAgeReg), eulerAgeReg, method='spearman', use='complete'),
                                       cor(as.numeric(TotalGrayVolAgeReg), eulerAgeReg, method='spearman', use='complete'))
...
meanValsAgeRegEulerPValValid <- cbind(cor.test(meanCTAgeReg, eulerAgeReg, use='complete',method='spearman')$p.value,
                                       cor.test(meanGMDAgeReg, eulerAgeReg, use='complete',method='spearman')$p.value,
                                       cor.test(meanVOLAgeReg, eulerAgeReg, use='complete',method='spearman')$p.value,
                                       cor.test(as.numeric(meanFSCtAgeReg), eulerAgeReg, use='complete',method='spearman')$p.value,
                                       cor.test(as.numeric(TotalGrayVolAgeReg), eulerAgeReg,use='complete', method='spearman')$p.value)
...
trainData <- rbind(meanValsAgeRegAverageRating, meanValsAgeRegOneVsTwo, meanValsAgeRegEuler)
trainDataSig <- rbind(meanValsAgeRegAverageRatingPVal, meanValsAgeRegOneVsTwoPVal, meanValsAgeRegEulerPVal)
...
rownames(trainData) <- c('Average Rating', 'Quantification Model', 'Euler Number')
rownames(trainDataSig) <- c('Average Rating PVal', 'Quantification Model PVal', 'Euler Number PVal')
...
validData <- rbind(meanValsAgeRegAverageRatingValid, meanValsAgeRegOneVsTwoValid, meanValsAgeRegEuler)
validDataSig <- rbind(meanValsAgeRegAverageRatingPValValid, meanValsAgeRegOneVsTwoPValValid, meanValsAgeRegEulerPVal)
...
rownames(validData) <- c('Average Rating', 'Quantification Model', 'Euler Number')
rownames(validDataSig) <- c('Average Rating PVal', 'Quantification Model PVal', 'Euler Number PVal')
