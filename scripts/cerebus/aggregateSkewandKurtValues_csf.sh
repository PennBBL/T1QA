...
outputCSV="/home/adrose/skewAndKurtTest/reports/CSFoutputSkewAndKurtVals${1}.csv"
...
for i in `cat ${subjectList}` ; do 
  ...
  maskImg=`ls /import/GO/qapOutputDirectory/test_param/${bblid}/*mprage*/nifti/anatomical_csf_mask/segment_seg_0.nii.gz`
