...
outputCSV="/home/adrose/skewAndKurtTest/reports/GMoutputSkewAndKurtVals${1}.csv"
...
for i in `cat ${subjectList}` ; do 
  ...
  maskImg=`ls /import/GO/qapOutputDirectory/test_param/${bblid}/*mprage*/nifti/anatomical_gm_mask/segment_seg_1.nii.gz`
