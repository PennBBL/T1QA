...
outputCSV="/home/adrose/skewAndKurtTest/reports/WMoutputSkewAndKurtVals${1}.csv"
...
for i in `cat ${subjectList}` ; do 
  ...
  maskImg=`ls /import/GO/qapOutputDirectory/test_param/${bblid}/*mprage*/nifti/anatomical_wm_mask/segment_seg_2.nii.gz`
